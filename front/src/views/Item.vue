      ...
      comments: [
        {
          id: 1,
          user: "John Doe",
          avatar: "https://th.bing.com/th/id/OIP.ZtrvDWpDrJNiyRQj6DwPvwAAAA?w=171&h=180&c=7&r=0&o=5&dpr=2.2&pid=1.7", // 用户头像URL
          text: "Great post!",
          replies: [
            {
              id: 3,
              user: "Jane Doe",
              avatar: "https://th.bing.com/th/id/OIP.pL9aeO50HMujMSzGcOPhKwAAAA?w=177&h=180&c=7&r=0&o=5&dpr=2.2&pid=1.7", // 用户头像URL
              text: "@John Doe Thanks!",
            },
            {
              id: 4,
              user: "qqqqq",
              avatar: "https://th.bing.com/th/id/OIP.KfOvu0YNJ41PAA188ovG2gAAAA?w=115&h=180&c=7&r=0&o=5&dpr=2.2&pid=1.7", // 用户头像URL
              text: "888888",
            }
          ]
        },
        {
          id: 2,
          user: "Jane Doe",
          avatar: "https://th.bing.com/th/id/OIP.KyVdLcQqh3WpE6jmFj0OlQAAAA?w=190&h=190&c=7&r=0&o=5&dpr=2.2&pid=1.7", // 用户头像URL
          text: "I love this!",
          replies: []
        }
      ] // 假设这是从API加载的评论列表
